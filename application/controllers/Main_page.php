...
class Main_page extends MY_Controller
{
    ...
    /**
     * Вложеность коментариев не ограниченна. За вложеность отвечает поле reply_id.
     * Если оно NULL то это нулевая вложеность и коментрай оставлен к посту.
     * Если не NULL то оно указывает к какому коментарию оставлен данный комент.
     *
     * На фронте, коментарий, который оставлен к какому-то коментарию, не выводится
     * под этим коментом, а все коменты и к посту, и к коментрию идут в одном порядке,
     * только связываются ссылками (как на многих форумах).
     *
     * Возможно, в задании имелось ввиду, что вложенные коментарии и на фронте будут иметь
     * структуру вложености, что бы проверить уменние писать рекурсивыне функции :)
     * Но так как вложеность у нас не ограничена, то такая вложеность на фронте может в какие-то моменты
     * выглядить не красиво.
     *
